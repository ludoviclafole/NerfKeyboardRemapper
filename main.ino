...
uint8_t to[21] = {0x45, 0x14, 0x04, 0x1B, 0x16, 0x1D, 0x06, 0x07, 0x08, 0x19, 0x09, 0x15, 0x05, 0x0A, 0x17, 0x11, 0x0B, 0x1C, 0x36, 0x0D, 0x18};
...
void loop() {
  if (irrecv.decode(&results)) {
    int test = results.value & 0xFF000000;
    if (test == 0) {
